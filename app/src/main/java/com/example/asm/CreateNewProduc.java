...
public class CreateNewProduc extends AsyncTask<String,String,String> {
    Context context;
    ProgressDialog pDialog;
    JSONParser jsonParser;
    public CreateNewProduc(Context context){
    ...
    protected String doInBackground(String... strings) {
        ...
        HashMap<String,String> hsCreateAt=new HashMap<>();
        hsCreateAt.put("created_at",strings[3]);
        params.add(hsCreateAt);
