...
public class SaveProductDetails extends AsyncTask<String,String,String> {
    ...
    public SaveProductDetails(Context context){
    ...
    protected String doInBackground(String... strings) {
        ...
        HashMap<String,String> hsCreatedAt=new HashMap<>();
        hsCreatedAt.put(Constants.TAG_CREATED_AT,strings[4]);
        params.add(hsCreatedAt);
